  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        Stack(
          children: [
            ...
            Positioned(
                ...
                child: const DrImages(
                    image: AssetImage('assets/images/ladyDr.jpg'), radius: 45)),
            Positioned(
        ...
        const Text('Consultation app of the cuntury for your',
            style: TextStyle(
                color: Colormanager.blackText, fontWeight: FontWeight.w500)),
        const Text('health and medical needs!',
            style: TextStyle(
                color: Colormanager.blackText, fontWeight: FontWeight.w500)),
      ],
    );
